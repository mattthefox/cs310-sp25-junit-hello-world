...
public class ExampleTest {
    ...
    private String expectedCapitol;
    ...
    @Test
    public void testStateCapitol() {
        //assertEquals(expectedCapitol, "Birmingham");
        assertEquals(expectedCapitol, "Montgomery");
    }
